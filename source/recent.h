...
C***** DEBUG
c     PARAMETER (MAXRES = 210000) ! Max. # of resonances
      PARAMETER (MAXRES = 600000) ! Max. # of resonances
C***** DEBUG
...
C-----04/05/09 - INCREASED FROM 120,000 TO 210,000
C-----01/04/07 - ADDED MAXPT FOR CROSS SECTION POINT VALUES.
C-----01/04/07 - INCREASED FROM 360,000 TO 600,000
C-----02/10/10 - TRIED INCREASING FROM 600,000 TO 1,200,000
C-----           NO RUNNING TIME ADVANTAGE = BACK TO 600,000.
...
C***** DEBUG
C     COMMON ENRES(MAXRES),SHIFT2(MAXRES),ENODE(MAXRES),WIDNOD(MAXRES),
C    1 RESTAB(12,MAXRES),RESJTAB(MAXRES)
C***** DEBUG
      COMMON ENRES(MAXRES),SHIFT2(MAXRES),ENODE(MAXRES),WIDNOD(MAXRES),
     1 RESTAB(12,MAXRES),RESJTAB(MAXRES),RESTABER(MAXRES)
C***** DEBUG
C
...
C
      ...
      COMMON ETAB2 (MAXPT+1),SIG2 (MAXNREACT,MAXPT+1),
     1       ETAB3 (MAXPT),  SIG3 (MAXPT),
     1       ETAB23(MAXPT),  SIG23(MAXPT),SIGMID(MAXNREACT),
...
C     OR READ WHILE STILL KEEPING 1 ENERGY POINT IN MEMORY.
      ...
      DIMENSION ETAB2X(MAXPT),SIG2X(MAXNREACT,MAXPT)
