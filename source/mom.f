...
c     **************************************************************
      ...
      integer*4 lamax1,ix,ita,ipol,i,j
      lamax1 = lamax
      DO ita=1,32                                                  
         DO IX=1,200                                                 
            valf(ix,ita)=0.0d0
...
c     ****************************************************************
      implicit none
      real*8 frc(200), grc(200), ofr(200), ogr(200),t
      integer*4 nblk8
      include 'mom.cmb'
