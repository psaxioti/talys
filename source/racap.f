...
c
      include "talys.cmb"
      integer i,J,par,parity,Zix,Nix,nex
      integer iopt,prac(numlev2)
      real jrac(numlev2),qq
      real erac(numlev2),exfin(numlev2)
      real jlmracap1(numjlm),vncap1,rvncap1,avncap1,xsall(3)
      real xspex(numlev2),xsp(numlev2,0:numJph,2),spfacst(numlev2)
      real*8 pZ
c
...
c     jlmracap: JLMB potential for the radial grid: [0.1, 20] with a step of 0.1
c
...
c++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
c
c     end of data and values setting, beginning the main program of racap.
c
c++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
c
      return
...
c
 ...
 1999 format(f8.2,2x,f6.3,8a8)
  ...
  902 format(9f8.4)
  907 format(i4,8f8.4)
   97 format(//'  folding potential',//,
     *4x,'r',9x,'u',10x,'ud',10x,'ue',/)
   98 format(f8.3,10d12.4)
