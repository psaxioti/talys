...
c
     ...
     +                 pardif2,Irspin2,J2minI2,J2plusI2,l2primebeg,
     +                 l2primeend,l2prime,lprime,modl,irad,jj2primebeg,
     +                 jj2primeend,jj2prime,updown2
...
c                  
   ...
   40         continue
              if (type.eq.6.and.denomhf.eq.0.) goto 30
            endif
...
c
                  ...
                  J2plusI2=J2+Irspin2
                  l2primebeg=abs(J2minI2-parspin2)
                  l2primeend=abs(J2plusI2+parspin2)
...
c
                  if (type.eq.0) then
                    do 70 l2prime=l2primebeg,l2primeend,2
                      lprime=l2prime/2
                      modl=mod(lprime,2)
...
c      
                    do 80 l2prime=l2primebeg,l2primeend,2
                      lprime=l2prime/2
                      modl=mod(lprime,2)
                      if (modl.ne.pardif2) goto 80
                      if (flagfullhf) then
   ...
   90                   continue
                        ...
                        total=total+s2plus1*Tlnex(type,nexout,lprime)
                      endif
   80               continue
                  endif
c
