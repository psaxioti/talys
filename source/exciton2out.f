        ...
        do 10 ppi=ppi0,maxpar
          ...
          do 10 pnu=pnu0,maxpar
            if (ppi+pnu.eq.p) then
              ...
              n=p+h
              call matrix(Ainit,n)
              write(*,'(4(i2,3x),1p,4e12.5)') ppi,hpi,pnu,hnu,M2pipi,
...
c
      ...
      write(*,'("p(p) h(p) p(n) h(n)",6x,7(a8,6x),"Total"/)') 
      ...
      do 20 p=p0,maxpar
        do 20 ppi=ppi0,maxpar
          ...
          do 20 pnu=pnu0,maxpar
            if (ppi+pnu.eq.p) then
              hnu=pnu-pnu0
              write(*,'(4(i2,3x),1p,8e14.5)') ppi,hpi,pnu,hnu,
...
c
      ...
      write(*,'("lambdanuplus    lambdapinu     lambdanupi"/)') 
      do 40 p=p0,maxpar
        do 40 ppi=ppi0,maxpar
          ...
          do 40 pnu=pnu0,maxpar
            if (ppi+pnu.eq.p) then
              hnu=pnu-pnu0
              write(*,'(4(i2,3x),1p,4e15.5)') ppi,hpi,pnu,hnu,
   ...
   40 continue
      ...
      write(*,'("gammanuplus    gammapinu      gammanupi"/)') 
      do 50 p=p0,maxpar
      ...
      do 60 p=p0,maxpar
        do 60 ppi=ppi0,maxpar
          ...
          do 60 pnu=pnu0,maxpar
            if (ppi+pnu.eq.p) then
              hnu=pnu-pnu0
              write(*,'(4(i2,3x),1p,e15.5)') ppi,hpi,pnu,hnu,
