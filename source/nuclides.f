...
c
c Assignment of default values: Width fluctuation corrections are
c included for incident energies up to the separation energy.
c
      if (ewfc.eq.-1..and.k0.gt.0) ewfc=S(parZ(k0),parN(k0),k0)
c     
