...
!
      ...
      real         denom    ! help variable
      real         expo     ! help variable
      real         sigma2ph ! spin cutoff factor for particle-hole states
      real*8       newspin! new spin cutoff parameter
      real*8       spin_wigner ! Wigner distribution
      real*8       f(3)   ! help variable
      real*8       eta    ! help variable
!
